...
# Change this line
CORS(app, supports_credentials=True, origins=["http://localhost:5173", "https://voicecare-ten.vercel.app"])
#chat_histories = {}
...
# Replace this line in your Flask app
@app.after_request
def add_cors_headers(response):
    origin = request.headers.get('Origin')
    # Only allow your frontend origins
    if origin in ["http://localhost:5173", "https://voicecare-ten.vercel.app"]:
